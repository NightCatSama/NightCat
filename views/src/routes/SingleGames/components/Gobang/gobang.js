...
export default class Chess {
	constructor(el, options){
        ...
        this.size = this.size || this.checkerboard.offsetWidth
	...
	getMousePos(e) {
        ...
        let bounds = this.checkerboard.getBoundingClientRect()
	...
	checked(x, y) {
		...
		if (!this.over) {
			...
			return setTimeout(() => this.callback(this.player))
		}
		this.piece_count++
		if (this.piece_count === 225) {
			return setTimeout(() => this.callback())
		}
	}
	/*  生成个棋子  */
